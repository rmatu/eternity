...
import { mergeTwoArraysOfObject } from "../utils";
...
export const totalProductsPrice = expressAsyncHandler(async (req, res) => {
  //@ts-ignore
...
export const getAllUserOrders = expressAsyncHandler(async (req, res) => {
  //@ts-ignore
